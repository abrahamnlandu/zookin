...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-gray-50 dark:bg-gray-900">
      ...
      <div className="md:w-1/2 bg-gradient-to-br from-green-600 to-green-900 dark:from-blue-750 dark:to-blue-950 text-white p-12 flex flex-col justify-center items-center">
        <motion.div
