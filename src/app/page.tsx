  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <motion.div
        ...
        className="w-full max-w-2xl bg-gray-800/50 dark:bg-gray-800/50 rounded-2xl shadow-xl overflow-hidden relative z-10 backdrop-blur-sm"
      >
        <div className="p-12 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-gray-300 dark:text-white mb-4">
            <span className="text-green-400 dark:text-green-400">Jardin Zoologique</span> de Kinshasa
          </h1>
          <p className="text-xl text-gray-300 dark:text-gray-300 mb-10 max-w-lg mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="flex items-center justify-center space-x-2">
              ...
              <span className="text-sm text-gray-300 dark:text-gray-300">Kinshasa, RDC</span>
            </div>
            <div className="flex items-center justify-center space-x-2">
              <svg className="w-5 h-5 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
              </svg>
              <span className="text-sm text-gray-300 dark:text-gray-300">Ouvert 7j/7</span>
            </div>
            <div className="flex items-center justify-center space-x-2">
              <svg className="w-5 h-5 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"/>
              </svg>
              <span className="text-sm text-gray-300 dark:text-gray-300">Animaux protégés</span>
            </div>
          </div>
